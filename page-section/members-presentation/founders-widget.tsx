...
export default function SectionFounders({className}: ComponentPropsWithoutRef<'section'>) {
   ...
   let currentLanguage = useAppLanguage(store => store.currentLanguage);
   ...
   return (
      <section
         className={twMerge(
            'relative mx-auto flex w-full max-w-[1440px] flex-col lg:grid lg:grid-cols-2',
            className
         )}>
         <ul
            className={twMerge(
         ...
         <article
            ...
            <main className={' flex flex-col items-center justify-center gap-2 px-2 pb-8 md:px-6'}>
