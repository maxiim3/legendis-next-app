    ...
    return (
        <>
            <motion.section
                ...
                className={cn(
                    "absolute z-50 h-screen w-screen bg-base-100/80 p-4 sm:p-8 md:p-24"
                )}>
                <LogoMotion
                    longPath={path}
                    shortPath={path}
            ...
            <motion.section
                ...
                <div
                    ...
                    <motion.main
                        className={
                            "mx-auto flex h-full w-full flex-col items-center gap-8"
                        }
                        initial={{opacity: 0}}
                        animate={{opacity: 1}}
                        transition={{duration: 1, delay: 3}}>
                        <div
                            className={
                                "prose flex flex-col items-center text-center text-balance"
                            }>
                        ...
                        <div
                            ...
                            <aside
                                className={
                                    "h-48 w-1/3 animate-pulse rounded-xl bg-base-300/70"
                                }></aside>
                            <div
                                className={
                                ...
                                <small>
                                    En partenariat avec Warner Music France
                                </small>
                            </div>
                        </div>
                    </motion.main>
