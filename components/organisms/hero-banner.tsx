...
const YOUTUBE_LINK_MAKINGOF = 'https://www.youtube.com/watch?v=dMrhkQYBRww&t';
...
function AlbumEdithPiaf() {
   const currentLang = useI18nContext(store => store.currentLanguage);
   return (
      <article className={'flex w-full flex-col gap-1  md:justify-around  md:pt-12'}>
         <Prose
            className={
