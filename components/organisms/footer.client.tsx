         ...
         <div className='space-opacity-8 lg:space-opacity-16 mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8'>
            ...
            <div className='grid grid-cols-1 gap-8 border-t border-primary/80 pt-8 sm:grid-cols-2 lg:pt-16'>
               <FooterSection>
                  ...
                  <FooterItemWithLink href={`https://prod203.com/${currentLanguage}`}>
               ...
               <FooterSection>
                  ...
                  <FooterItemWithLink href={'https://github.com/maxiim3/prod203-next-app'}>
                     <Github className={'w-4'} />
                     Maxime Tamburrini
                  </FooterItemWithLink>
                  <FooterItemWithLink href={'https://digitalsolution.studio'}>
                     <DSS className={'h-6 w-6 fill-neutral-50 opacity-70'} />
